<?php 
  ...
  $pt = isset($_POST['pt']) ? stripslashes($_POST['pt']) : 'pssst ... don’t tell anyøne!';
...
<form name="frm" id="frm" method="post" action=""> <!-- same-document reference -->
  <table>  
    ...
    <tr>
      <td>Plaintext:</td>
      <td><input type="text" name="pt" size="40" value="<?php echo htmlspecialchars($pt) ?>"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="text" name="plain" size="40" value="<?php echo htmlspecialchars($decr) ?>"></td>
    </tr>
  </table>
</form>
<p><?php echo intval((microtime(true) - $timer)*1000) ?>ms</p>
</body>
</html>